    ...
    <div class="metas">
      ...
      <p class="item">
        ...
        <span class="site-url" @click="copyArticleUrl">
          <span>https://peytonis.aitboy.cn/article/{{ article.id }}</span>
        </span>
      </p>
      <div class="item">
    ...
    methods: {
      ...
      copyArticleUrl() {
        if (this.article.title) {
          // console.log('要复制了', `https://outNapGnaw.me/article/${this.article.id}`, this.$root.$copyToClipboard)
          this.$root.$copyToClipboard(`https://outNapGnaw.me/article/${this.article.id}`)
        }
      },
      buildThumb(thumb) {
