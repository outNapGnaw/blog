            ...
            <div class="about-me">
              <div class="desc">
                <p class="item">
                  ...
                  <span v-if="langIsEn"><span class="first-letter">I</span>'m Peyton, a Web developer.</span>
                  <span v-else>
                    <span class="first-letter">我</span>
                    <span>，有一头乌黑浓密的头发</span>
                  </span>
                </p>
                <p class="item">
                  <i class="iconfont icon-music"></i>
                  <nuxt-link to="/music">Roit</nuxt-link>
                </p>
                <p class="item">
                  <i class="iconfont icon-like"></i>
                  <span v-if="langIsEn">read. code. beauty. game. music. and my wife</span>
                  <span v-else>
                    <span>我喜欢？</span>
                    <strong>阅读诚可贵，代码价更高，若问媳妇故，两者皆可抛</strong>
                  </span>
                </p>
                <p class="item">
                  ...
                  <span class="accounts">
                    <span>
                      <a href="https://github.com/outNapGnaw"
                         target="_blank"
                         class="github"
                         rel="external nofollow noopenter">
                        <i class="iconfont icon-github"></i>
                      </a>
                      <a href="mailto:wangpeyton@gmail.com"
                         target="_blank"
                         class="mail"
                         rel="external nofollow noopenter">
                        <i class="iconfont icon-mail"></i>
                      </a>
                      <a href="https://www.zhihu.com/people/outNapGnaw/activities"
                         target="_blank"
                         class="zhihu"
                         rel="external nofollow noopenter">
                        <i class="iconfont icon-zhihu"></i>
                      </a>
                      <a href="https://weibo.com/outNapGnaw"
                         target="_blank"
                         class="weibo"
                         rel="external nofollow noopenter">
                        <i class="iconfont icon-weibo"></i>
                      </a>
                      <a href="http://space.bilibili.com/28889347"
                         target="_blank"
                         class="bilibili"
                         rel="external nofollow noopenter">
                    ...
                    <span v-if="!mobileLayout">
                      <a href="https://stackoverflow.com/users/6606328/outnapganw"
                         target="_blank"
                         class="stackoverflow"
                         rel="external nofollow noopenter">
                        <i class="iconfont icon-stackoverflow"></i>
                      </a>
                      <a href="https://leetcode.com/wangpeyton/"
                         target="_blank"
                         class="algorithm"
                         rel="external nofollow noopenter">
                        <i class="iconfont icon-algorithm"></i>
                      </a>
                      <a href="https://twitter.com/outNapGnaw"
                         target="_blank"
                         class="twitter"
                         rel="external nofollow noopenter">
                        <i class="iconfont icon-twitter"></i>
                      </a>
                      <a href="https://www.facebook.com/peyton.wang.39"
                         target="_blank"
                         class="telegram"
                         rel="external nofollow noopenter">
                        <i class="iconfont icon-facebook"></i>
                      </a>
                      <a href="https://www.instagram.com/outNapGnaw/"
                         target="_blank"
                         class="instagram"
                         rel="external nofollow noopenter">
                ...
                <p class="item">
                  ...
                  <span class="skills" v-if="langIsEn">Nothing</span>
                  <span v-else>
                    <strong>一个人肯为他奋斗的目标去死，别人还能苛责什么呢？还能挑剔什么呢？</strong>
                  </span>
                </p>
                <p class="item" v-if="!mobileLayout">
                  <i class="iconfont icon-friend"></i>
                  <span class="friends">
                    <a href="https://github.com/lxp521125" 
                       target="_blank"
                       rel="external nofollow noopenter">
                       「 lxp521125 」
                    </a>
                    <a href="http://www.fufan.me/" 
                       target="_blank"
                       rel="external nofollow noopenter">
                       「 fae88 」
                    </a>
                    <a href="https://www.fyazy.cn/" 
                       target="_blank"
                       rel="external nofollow noopenter">
                       「 fy 」
                    </a>
              ...
              <div class="gravatar" @click="followMe">
                ...
                <div class="desc">
                  <h2 class="name"><strong>outNapGnaw</strong></h2>
                  <p class="skill">Web Developer.</p>
                </div>
                <a class="followme" 
                   href="" 
                   @click.stop.prevent=""
                   v-if="!mobileLayout">{{ langIsEn ? 'Friend me' : '别说话，加我' }}</a>
