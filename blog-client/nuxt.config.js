...
const htmlSlogan = htmlLang === 'zh' ? '好看的灵魂，有趣的皮囊' : 'Do it'
...
module.exports = {
  ...
  head: {
    title: `outNapGnaw.me - ${htmlSlogan}`,
    titleTemplate: '%s | outNapGnaw.me',
    htmlAttrs: {
    ...
    meta: [
      ...
      { name: 'author', content: 'wangpeyton@gmail.com' },
      ...
      { hid: 'keywords', name: 'keywords', content: 'outNapGnaw,老王,Vue开发者,前端技术开发,javascript技术' },
